...
linux:
	...
	# nvcc -arch=sm_61 -Xcompiler -march=znver4 -ccbin /usr/bin/g++-11 hungarian_algo_test.cu hungarian_lib.cu hungarian_cpu_vectorized.cpp -o hungarian_algo_test -lrt
